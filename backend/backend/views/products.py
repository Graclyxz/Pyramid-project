...
def listar_productos(request):
    ...
    productos_dict = [serialize_sqlalchemy_object(producto) for producto in productos]
...
def obtener_productos(request):
    ...
    producto_dict = serialize_sqlalchemy_object(producto)
...
def eliminar_productos(request):
    ...
    producto_dict = serialize_sqlalchemy_object(producto)
    return HTTPOk(json_body={'message': 'Producto eliminado', 'Producto': producto_dict})
